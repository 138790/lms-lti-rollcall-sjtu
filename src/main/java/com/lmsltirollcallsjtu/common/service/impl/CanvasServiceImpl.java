...
public class CanvasServiceImpl implements CanvasService {
    ...
    @Override
    public List<Sections> getSectionDetail(String bearerToken,Long courseId,Long sectionId) {
        ResponseEntity<Sections> responseEntityTemp = canvasFeignClient.getSectionDetail(canvasFeignProperties.getSupperAdminToken(), courseId, sectionId);
        ResponseEntity<List<Sections>> responseEntity= canvasFeignClient.getSections(canvasFeignProperties.getSupperAdminToken(),courseId);

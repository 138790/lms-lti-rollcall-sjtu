...
public class ScanSignSercieImpl implements ScanSignServcie {
    ...
    public void scanUpdateState(String signScanToken,Long userCode) throws BusinessException, InterruptedException {
        ...
        //3.查询本次点名该用户的签到状态
        String SignInState = scanSignBasicService.queryStateByRecordId(signHistoryId,userCode);

...
public class CombineAttendanceBasicServiceImpl implements CombineAttendanceBasicService {
    ...
    @Override
    public void updateIsNotValidByUsersCombineList(List<UsersCombine> usersCombineList) {
        combineAttendancesDao.updateIsNotValidByUsersCombineList(usersCombineList);
    }

    @Override
    public void updateIsNotValidByUsersCombineLists(List<UsersCombine> usersCombineLists) {
        combineAttendancesDao.updateIsNotValidByUsersCombineLists(usersCombineLists);
    }
}
